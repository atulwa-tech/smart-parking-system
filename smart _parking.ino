...
// ── Backend Server ───────────────────────────────────────────
// IMPORTANT: Find your PC's local IP by running 'ipconfig' in Command Prompt
// Look for "IPv4 Address" (e.g., 192.168.x.x)
// ESP32 and your PC MUST be on the same WiFi network
const char* SERVER_IP   = "http://192.168.1.100:3000";  // ← UPDATE THIS!
